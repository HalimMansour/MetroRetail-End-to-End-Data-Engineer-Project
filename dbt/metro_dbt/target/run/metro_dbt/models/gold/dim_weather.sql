    ...
    USE [MetroRetailDB];
    EXEC('
        create view "Gold"."dim_weather__dbt_tmp__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "MetroRetailDB"."Gold"."dim_weather__dbt_tmp" FROM "MetroRetailDB"."Gold"."dim_weather__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS Gold.dim_weather__dbt_tmp__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'Gold_dim_weather__dbt_tmp_cci'
        AND object_id=object_id('Gold_dim_weather__dbt_tmp')
    )
    DROP index "Gold"."dim_weather__dbt_tmp".Gold_dim_weather__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX Gold_dim_weather__dbt_tmp_cci
    ON "Gold"."dim_weather__dbt_tmp"
