    ...
    USE [MetroRetailDB];
    EXEC('
        create view "Gold"."fact_inventory_snapshot__dbt_tmp__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "MetroRetailDB"."Gold"."fact_inventory_snapshot__dbt_tmp" FROM "MetroRetailDB"."Gold"."fact_inventory_snapshot__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS Gold.fact_inventory_snapshot__dbt_tmp__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'Gold_fact_inventory_snapshot__dbt_tmp_cci'
        AND object_id=object_id('Gold_fact_inventory_snapshot__dbt_tmp')
    )
    DROP index "Gold"."fact_inventory_snapshot__dbt_tmp".Gold_fact_inventory_snapshot__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX Gold_fact_inventory_snapshot__dbt_tmp_cci
    ON "Gold"."fact_inventory_snapshot__dbt_tmp"
